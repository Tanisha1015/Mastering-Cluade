/**
 * Regression test for notification-service
 * Generated by Subagent Beta (QA Agent) at 2026-05-16T21:37:33.426Z
 * Fixed Bug: CM-004 ΓÇö notification-service
 *
 * This test ensures the service remains healthy after the Chaos Monkey fix.
 * Run: node services/notification-service/tests/regression.test.js
 */
...
async function runTests() {
  ...
  // Bug: CM-004 ΓÇö notification-service
  await assert('Regression: Service not affected by CM-004', async () => {
    const res = await httpGet(PORT, '/health');
